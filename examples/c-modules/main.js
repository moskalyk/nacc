...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    loadPackage({"files": [{"filename": "/main.data", "start": 0, "end": 0}, {"filename": "/compile.sh", "start": 0, "end": 287}, {"filename": "/main.wasm", "start": 287, "end": 84850}, {"filename": "/main.c", "start": 84850, "end": 89641}, {"filename": "/index.html", "start": 89641, "end": 91452}, {"filename": "/main.js", "start": 91452, "end": 338046}], "remote_package_size": 338046, "package_uuid": "0b82addf-fdf3-4c06-b26d-13871c11a666"});
...
var ASM_CONSTS = {
  4144: function($0) {var ws = new WebSocket('ws://127.0.0.1:8080'); ws.onopen = function() { ws.send(UTF8ToString($0)); }; ws.close();},  
 4262: function() {if (typeof Module.websocket === 'undefined') { Module.websocket = new WebSocket('ws://127.0.0.1:8080'); Module.websocket.onopen = function() { console.log('Connected to WebSocket server'); Module.websocket.send('Hello Server'); }; function startThroughputMeasurement() { setInterval(function() { Module.ccall('update_throughput', 'void', [], []); }, 1000); } Module.websocket.onmessage = function(event) { Module.ccall('process_json_response', 'void', ['string'], [event.data]); Module.ccall('increment_message_count', 'void', [], []); }; Module.websocket.onerror = function(error) { console.error('WebSocket error:', error); }; Module.websocket.onclose = function() { console.log('WebSocket connection closed'); }; startThroughputMeasurement(); }}
};
...
/** @type {function(...*):?} */
var _update_throughput = Module["_update_throughput"] = createExportWrapper("update_throughput");

/** @type {function(...*):?} */
var _increment_message_count = Module["_increment_message_count"] = createExportWrapper("increment_message_count");

/** @type {function(...*):?} */
var _get_delayed_response = Module["_get_delayed_response"] = createExportWrapper("get_delayed_response");

/** @type {function(...*):?} */
var _free_delayed_response = Module["_free_delayed_response"] = createExportWrapper("free_delayed_response");

/** @type {function(...*):?} */
var _free = Module["_free"] = createExportWrapper("free");

/** @type {function(...*):?} */
var _process_json_response = Module["_process_json_response"] = createExportWrapper("process_json_response");

/** @type {function(...*):?} */
var _malloc = Module["_malloc"] = createExportWrapper("malloc");

/** @type {function(...*):?} */
var _my_c_function = Module["_my_c_function"] = createExportWrapper("my_c_function");
