...
import { UnsignedMigration } from "../migrator.js";
import { Migration_v1v2 } from "./migration_01_02.js";
export declare const MIGRATION_NONCE_SPACE = "0xa04263acf755e8bd19c0d7e20eea39a9ff3729eb";
export interface Migration<P extends commons.config.Config, C extends commons.config.Config> {
    ...
    decodeTransaction: (tx: commons.transaction.TransactionBundle, contexts: commons.context.VersionedContext) => {
        address: string;
        newImageHash: string;
    };
...
export declare const v1v2: Migration_v1v2;
